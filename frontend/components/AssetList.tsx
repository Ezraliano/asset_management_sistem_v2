...
const AssetList: React.FC<AssetListProps> = ({ navigateTo }) => {
  ...
  const statusColorMap: { [key in AssetStatus]: string } = {
    ...
    [AssetStatus.DALAM_PERBAIKAN]: 'bg-yellow-100 text-yellow-800',
    [AssetStatus.RUSAK]: 'bg-red-100 text-red-800',
    [AssetStatus.DALAM_PEMELIHARAAN]: 'bg-purple-100 text-purple-800',
  };
