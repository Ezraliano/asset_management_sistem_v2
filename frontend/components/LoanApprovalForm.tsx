...
import { approveAssetLoan } from '../services/api';

interface LoanApprovalFormProps {
  loan: AssetLoan;
  onApprove: (approvedLoan: AssetLoan) => void;
  onCancel: () => void;
  loading?: boolean;
}
...
const LoanApprovalForm: React.FC<LoanApprovalFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const approvedLoan = await approveAssetLoan(loan.id, formData);
      onApprove(approvedLoan);
    ...
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-2xl mx-auto max-h-[80vh] overflow-y-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end space-x-3 pt-4 border-t">
          ...
          <button
            type="submit"
            disabled={isSubmitting || !approvalDate || !selectedPhoto}
