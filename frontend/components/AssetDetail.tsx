                                ...
                                <li key={maint.id} className={`p-4 rounded-lg border hover:shadow-md transition-all ${
                                    ...
                                    {maint.photo_proof && (
                                        <div className="mt-3 pt-3 border-t border-gray-200">
                                            ...
                                            <div className="mt-2">
                                                <img
                                                    src={`https://assetmanagementga.arjunaconnect.com/api/storage/${maint.photo_proof}`}
                                                    ...
                                                    onClick={() => window.open(`https://assetmanagementga.arjunaconnect.com/api/storage/${maint.photo_proof}`, '_blank')}
                                                />
                                            </div>
                                        </div>
                                    )}
