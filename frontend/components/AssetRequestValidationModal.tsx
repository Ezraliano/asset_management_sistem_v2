        ...
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          {request.status === 'APPROVED' && request.loan_photo_path && (
            <div className="mt-4">
              ...
              <div className="mt-2">
                <img
                  src={`https://assetmanagementga.arjunaconnect.com/api/storage/${request.loan_photo_path}`}
        ...
        <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          {request.return_proof_photo_path && (
            <div className="mb-3">
              ...
              <div className="mt-2">
                <img
                  src={`https://assetmanagementga.arjunaconnect.com/api/storage/${request.return_proof_photo_path}`}
